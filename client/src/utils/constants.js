export const POKEMON_URL = 'http://localhost:3001/api/pokemons';
export const POKEMON_TYPES = 'http://localhost:3001/api/types';
export const POKEMON_TYPES_API = 'https://pokeapi.co/api/v2/type';
export const POKEMON_NAME = 'http://localhost:3001/api/pokemons?name=';
...
export const POKEBALL_IMAGE = 'https://upload.wikimedia.org/wikipedia/commons/5/51/Pokebola-pokeball-png-0.png'
